...
public class DatabaseExample {
	 ...
	 * Make sure that your project also defines the h2 dependency <dependency>
	 1	* <groupId>com.h2database</groupId> <artifactId>h2</artifactId>
...
//				db.serializeToDatabase(1);
	...
	private static void createDatabaseViaCredentials() throws Exception {
		...
		try (H2DatabaseImageMatcher db = new H2DatabaseImageMatcher(dbName, userName, password)) {
			...
			// Image files / cargas las imagenes desde la ruta establecida
			File ballon = new File("src/test/resources/highQualityBase.png");
			//URL ballon = new URL("https://scontent.fuio4-1.fna.fbcdn.net/v/t1.0-9/56582270_2710388615698245_1568257078491873280_n.jpg?_nc_cat=106&_nc_ht=scontent.fuio4-1.fna&oh=b6ea0e774c461a0f6ea172f75a15d73c&oe=5D6BA1C8");
			File copyright = new File("src/test/resources/Lenna.png");
			//File copyright = new File("https://scontent.fuio4-1.fna.fbcdn.net/v/t1.0-9/56582270_2710388615698245_1568257078491873280_n.jpg?_nc_cat=106&_nc_ht=scontent.fuio4-1.fna&oh=b6ea0e774c461a0f6ea172f75a15d73c&oe=5D6BA1C8");
			File highQuality = new File("src/test/resources/highQuality.jpg");

			File Lenna = new File("src/test/resources/Lenna.png");

			db.addImages(ballon, copyright, highQuality, Lenna);
